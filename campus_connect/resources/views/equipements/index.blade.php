        ...
        <div class="col-md-4">
            <div class="card bg-light h-100">
                <div class="card-body text-center p-3">
                    ...
                    <h6 class="card-title mb-1">{{ $equipements->count() }} Équipements</h6>
                ...
                <div class="card h-100 card-hover">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <h5 class="card-title mb-0">{{ $equipement->nom }}</h5>
                            <span class="badge {{ $equipement->quantite > 0 ? 'bg-success' : 'bg-danger' }}">
                                {{ $equipement->quantite }} dispo
                            </span>
                        </div>
